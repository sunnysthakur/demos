...
{literal}
 ...
 <!--
   Bug id : 2536
   Description :A popup is displayed on uploading test cases in .xls file format.
   Date    : 04th Oct,2011
//-->
...
{literal}
 ...
 <!--
   Bug id : 2537
   Description : selected file type msg
   Date    : 13th Oct,2011
//-->
...
{ 
    ...
    var fileext = filename.substring(filelength,filelength + 3); 
      ...
      if (fileext != "xls" && fileext != "xml")
      {
         alert('Please Upload file in the selected File Type only');
	   return false;

      }else if(fileext != getlastextdata)
       {
           alert('Please Upload file in the selected File Type only');
	   return false;
...
<option value="XLS" label="XLS">XLS</option>
