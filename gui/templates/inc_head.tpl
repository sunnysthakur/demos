...
<head>
	...
	<base href="{$basehref}"/>
	<title>{$pageTitle|default:"TCMS 1.9.3"}</title>
...
{* ----- load CSS ------------------------------------------------------------------- *} 
	...
	<style media="all" type="text/css">@import "{$basehref}{$smarty.const.TL_SELECTION_CSS}";</style>
        <style media="all" type="text/css">@import "{$basehref}{$smarty.const.TL_INNERPAGE_CSS}";</style>
        <style media="all" type="text/css">@import "{$basehref}{$smarty.const.TL_HOMEPAGE_CSS}";</style>
	<style media="all" type="text/css">@import "{$basehref}{$smarty.const.TL_LIGHTBOX_CSS}";</style>
...
{* ----- load javascripts libraries -------------------------------------------------- *} 
	...
	<script type="text/javascript" src="{$basehref}gui/javascript/jquery-1_3_2/jquery-1.3.2.min.js" language="javascript"></script>
	<script type="text/javascript" src="{$basehref}gui/javascript/homepage_routines.js" language="javascript"></script>
